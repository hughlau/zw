...
namespace fw.m.sysBasicManage.data.model
{
    ...
    public class MMenuEx : MFWMenu
    {
        ...
        private List<MMenuEx> _mFWMenuExInfoList;
        /// <summary>
        /// id
        /// </summary>
        [DataMember]
        public List<MMenuEx> mFWMenuExInfoList
        {
            set { _mFWMenuExInfoList = value; }
            get { return _mFWMenuExInfoList; }
        }
