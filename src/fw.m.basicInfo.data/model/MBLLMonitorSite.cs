...
namespace fw.m.basicInfo.data.model
{
    ...
    /// </summary>
    [DataContract]
    public class MBLLMonitorSite : FWEntityObject
    {
        ...
        /// </summary>
        [DataMember]
        public List<MBLLMonitorSiteMonitorFactor> monitorFactorList { get; set; }

        /// <summary>
        /// 监测因子信息
        /// </summary>
        [DataMember]
        public List<MBas_MonitorSiteMonitorFactor> monitorBasFactorList { get; set; }

        /// <summary>
        /// 设备
        /// </summary>
        [DataMember]
        public List<MBLLEquipment> equipmentList { get; set; }

        /// <summary>
        /// 监测点报警列表
        /// </summary>
        [DataMember]
        public List<MMonitorSiteAlarmItem> monitorSiteAlarmList { get; set; }
        ...
        public string statusCode
        {
            ...
            set { _statusCode = changeValue("statusCode", _statusCode, value); }
        }
        ...
        /// </summary>
        [DataMember]
        public QuickResponseCodeInfo quickResponseCodeInfo { get; set; }
        ...
        {
            get { return _color; }
            set { _color = changeValue("color", _color, value); }
        }
