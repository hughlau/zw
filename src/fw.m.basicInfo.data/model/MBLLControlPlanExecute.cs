...
{
    [DataContract]
    public class MBLLControlPlanExecute : FWEntityObject
    {
        ...
        private string _planDetailName;
        [DataMember]
        public string planDetailName
        {
            get { return _planDetailName; }
            set { _planDetailName = changeValue("planDetailName", _planDetailName, value); }
        }
