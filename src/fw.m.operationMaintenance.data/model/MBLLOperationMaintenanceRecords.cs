...
namespace fw.m.operationMaintenance.data.model
{
    ...
    /// </summary>
    [DataContract]
    public class MBLLOperationMaintenanceRecords : FWEntityObject
    {
        ...
        private string _recordStatusName;
        ...
        {
            get { return _recordStatusName; }
            set { _recordStatusName = changeValue("recordStatusName", _recordStatusName, value); }
        }
        ...
        //维修结果名称
        private string _solveReasultName;
        [DataMember]
        public string solveReasultName
        {
            get { return _solveReasultName; }
            set { _solveReasultName = changeValue("solveReasultName", _solveReasultName, value); }
        }
        ...
        public string weatherName
        {
            ...
            set { _weatherName = changeValue("weatherName", _weatherName, value); }
        }
