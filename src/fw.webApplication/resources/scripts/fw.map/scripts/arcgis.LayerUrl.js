...
var GeometryUrl = "http://101.201.47.137:6080/arcgis/rest/services/Utilities/Geometry/GeometryServer";
...
function getInitMapParameter(cantonCode) {
    ...
    switch (cantonCode) {
        case CantonCodeList[0]:
            CantonLayerUrl = "http://101.201.47.137:6080/arcgis/rest/services/jjte/MapServer?f=jsapi";
