...
$.page.pageLoad = function () {
    ...
    var excelpath = fw.fwUrl.FWUrlHelper.getAbsoluteUrl("resources/office/realtimeData.xls", $.page.webSiteRootUrl)
...
//            }
    ...
    $.page.ajax($.page.getAjaxSettings({
        ...
        methodName: "importDataByExcel",
        data: {
            ticket: $.page.ticket, filePath: $.page.idM.filePath.getValue(), isupdate: isupdate
        },
