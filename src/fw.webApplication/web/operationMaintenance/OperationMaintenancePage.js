            ...
            if (fw.fwObject.FWObjectHelper.hasValue(monitorImgList)) {
                for (var i = 0; i < monitorImgList.length; i++) {
                    ...
                    if (!entityIsNull) {
                        ...
                        html += '<td><img class="hoverCls"  style="width: 60px; height: 60px" src=' + src + ' id=' + monitorImgList[i] + ' onmouseover="$.OperationMaintenancePage.mouseOver(this)" onmouseout="$.OperationMaintenancePage.mouseOut()"></img></td>';
                    }
            ...
            if (fw.fwObject.FWObjectHelper.hasValue(monitorImgList)) {
                for (var i = 0; i < monitorImgList.length; i++) {
                    ...
                    if (!entityIsNull) {
                        entity = fw.fwUrl.FWUrlHelper.getAbsoluteUrl(entity, 'upload/')
                        var src = fw.fwUrl.FWUrlHelper.getAbsoluteUrl(entity, $.page.webSiteRootUrl);
                        html += '<td><img class="hoverCls"  style="height: 60px" src=' + src + ' id=' + monitorImgList[i] + ' onmouseover="$.OperationMaintenancePage.mouseOverToLeft(this)" onmouseout="$.OperationMaintenancePage.mouseOut()"></img></td>';
                    }
