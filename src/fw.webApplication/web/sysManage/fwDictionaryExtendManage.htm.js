...
$.page.pageLoad = function () {
    ...
    var pageUrl = fw.fwUrl.FWUrlHelper.addParams(fw.fwUrl.FWUrlHelper.getAbsoluteUrl("web/sysManage/fwDictionaryTypeExtendList.htm", $.page.webSiteRootUrl), data);
...
function mDictionaryTypeCodeChangedCallback(entity) {
    ...
    if (fw.fwObject.FWObjectHelper.hasValue(entity) && fw.fwObject.FWObjectHelper.hasValue(entity.mDictionaryTypeCode)) {
        ...
        url = fw.fwUrl.FWUrlHelper.addParams(fw.fwUrl.FWUrlHelper.getAbsoluteUrl("web/sysManage/fwDictionaryExtendList.htm", $.page.webSiteRootUrl), data);
    } else {
