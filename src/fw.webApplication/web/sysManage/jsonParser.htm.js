...
$.page.pageLoad = function () {
    $.page.idJQ.buttonJsonParser.bind("click", function () {
        var jsonString = $.page.idJQ.txtJsonString.val();
        var data  = fw.fwJson.FWJsonHelper.deserializeObject(jsonString);
        ...
        $.page.idJQ.txtJson.val(dataJsonString);
        var ff = "";
    });
};
