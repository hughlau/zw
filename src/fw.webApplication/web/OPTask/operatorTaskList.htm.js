...
$.page.pageInit = function () {
    ...
    var begin = $.page.params.start;
    var end = $.page.params.end;
    begin = begin.split("+")[0].substring(1, begin.split("+")[0].length);
    end = end.split("+")[0].substring(1, end.split("+")[0].length);
    $.page.idM.mCallTimeFrom.setValue(begin);
    $.page.idM.mCallTimeTo.setValue(end);
};
...
function datagrid1_Load(pageIndex, pageSize, cSettings) {
    ...
    conditionData.TaskOMPersonCode = $.page.params.operationMaintenancePersonCode;
