...
$.page.pageLoad = function () {
    ...
    buttonAddJQ.bind("click", function () {
       ...
       console.log($.pageCustomer.enumOperate.add)
...
//打开新添加窗口前的传值 operationMaintenanceCode表示 传入的第二个参数 编码  编辑使用
function openInfo(action, operationMaintenanceTaskCode) {
    ...
    var pageParams = { url: "web/OPTask/dailyMaintenanceTask.htm", width: 800, height: 600, title: "设施的基本信息详情" };
