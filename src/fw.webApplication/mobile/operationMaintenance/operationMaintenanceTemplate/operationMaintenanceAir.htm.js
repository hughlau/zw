...
var operationMaintenanceAddress = null;
...
$.page.pageLoad = function () {
    ...
    operationMaintenanceAddress = $.page.params.operationMaintenanceAddress;
    //判断传入编码
            ...
            $.page.ajax($.page.getAjaxSettings({
                ...
                , data: {
                    ...
                    , mEntity: {
                        ...
                        , status: 4,
                        GPS: operationMaintenanceAddress
                    }
                }
                , beforeSend: function () {
                    $.mobile.loading('show');
            ...
            , success: function (resultData) {
                ...
                if (resultData.status == fw.fwData.FWResultStatus.Success && fw.fwObject.FWObjectHelper.hasValue(resultData.data)) {
                    ...
                    if (fw.fwObject.FWObjectHelper.hasValue(entity.operationMaintenanceFormData)) {
                      ...
                      $("#operationMaintenanceAddress ").val(operationMaintenanceAddress);
                    //                    var data = {
                    //                        ticket: $.page.ticket
