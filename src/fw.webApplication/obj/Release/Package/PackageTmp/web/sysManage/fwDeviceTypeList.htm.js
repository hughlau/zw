...
function datagrid1_Load(pageIndex, pageSize) {
    ...
    $.page.ajax($.page.getAjaxSettings({
        ...
        , methodName: "queryPageMFWDeviceType"
        , data: {
            ticket: $.page.ticket
            , pageParams: {
                pageSize: pageSize
...
function insertRow() {
    ...
    $.page.idM.datagrid1.beginEditCell(newRow, "mDataID");
};
...
function insertOrUpdate() {
    ...
    $.page.ajax($.page.getAjaxSettings({
        serviceType: "crossDomainCall"
        , serviceName: "sysManage"
        , methodName: "insertOrUpdateMFWDeviceTypeListByMDataID"
        , data: {
            ticket: $.page.ticket
            ...
            function (action) {
                if (action == "ok") {
                    ...
                    $.page.ajax($.page.getAjaxSettings({
                        serviceType: "crossDomainCall"
                        , serviceName: "sysManage"
                        , methodName: "deleteMFWDeviceTypeByMDataIDList"
                        , data: {
                            ticket: $.page.ticket
