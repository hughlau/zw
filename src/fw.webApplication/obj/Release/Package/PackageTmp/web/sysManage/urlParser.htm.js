...
$.page.pageLoad = function () {
    $.page.idJQ.buttonUrlParser.bind("click", function () {
        var txtUrl = $.page.idJQ.txtUrl.val();
        //var urlInfo = fw.fwUrl.FWUrlHelper.parser(txtUrl);
        var data = fw.fwUrl.FWUrlHelper.getParams(txtUrl);
        data.params = fw.fwJson.FWJsonHelper.deserializeObject(data.paramsJson);
        var dataJsonString = fw.fwJson.FWJsonHelper.serializeObject(data, undefined, fw.fwJson.FWJsonHelper.JsonFormatMode.ToFormatString);
        $.page.idJQ.txtUrlParser.val(dataJsonString);
        var ff = "";
    });
};
