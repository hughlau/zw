...
function datagrid1_Load(pageIndex, pageSize) {
    ...
    $.page.ajax($.page.getAjaxSettings({
        ...
        , methodName: "queryPageMFWUserType"
        , data: {
            ticket: $.page.ticket
            , pageParams: {
                pageSize: pageSize
...
function insertRow() {
    ...
    newRow.mIsDistribute = "0";
    newRow.mIsDis = "0"
    $.page.idM.datagrid1.addRow(newRow, 0);
    $.page.idM.datagrid1.beginEditCell(newRow, "mUserTypeName");
};



//保存，methodName值，与表名一致
function insertOrUpdate() {
    ...
    $.page.ajax($.page.getAjaxSettings({
        serviceType: "crossDomainCall"
        , serviceName: "sysManage"
        , methodName: "insertOrUpdateMFWUserTypeListByMDataID"
        , data: {
            ticket: $.page.ticket
...
//删除选中项
function deleteRow(mDataIDList) {
    //获得选中项编码集合
            ...
            function (action) {
                if (action == "ok") {
                    ...
                    $.page.ajax($.page.getAjaxSettings({
                        serviceType: "crossDomainCall"
                        , serviceName: "sysManage"
                        , methodName: "deleteMFWUserTypeByMDataIDList"
                        , data: {
                            ticket: $.page.ticket
