...
$.page.pageLoad = function () {
    ...
    var pageUrl = fw.fwUrl.FWUrlHelper.addParams(fw.fwUrl.FWUrlHelper.getAbsoluteUrl("web/sysManage/fwDictionaryTypeList.htm", $.page.webSiteRootUrl), data); 
...
function mDictionaryTypeCodeChangedCallback(entity) {
    ...
    if (fw.fwObject.FWObjectHelper.hasValue(entity) && fw.fwObject.FWObjectHelper.hasValue(entity.mDictionaryTypeCode)) {
        ...
        url =  fw.fwUrl.FWUrlHelper.addParams(fw.fwUrl.FWUrlHelper.getAbsoluteUrl("web/sysManage/fwDictionaryList.htm", $.page.webSiteRootUrl), data);
    } else {
