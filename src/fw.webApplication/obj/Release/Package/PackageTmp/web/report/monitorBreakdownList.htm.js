...
function openListInfo(  monitorSiteCode) {
    ...
    var pageParams = {};
    pageParams = { url: "web/report/monitorBreakdownDetailList.htm", width: 900, height: 600, title: "故障明细",showMaxButton:true };
...
function dataExport() {
    ...
    $.page.exportFile({ idM: $.page.idM.datagrid1, reportName: '设施故障统计' });
};