...
mini.extend(UserControl.MultiUpload, mini.DataGrid, {
    ...
    acceptMap: [
        ...
        { code: "*.dwg", text: "http://www.miniui.com/demo/multiupload/src/image/vnd.dwg" },
        { code: "*.dxf", text: "http://www.miniui.com/demo/multiupload/src/image/vnd.dxf" },
        ...
        { code: "*.svf", text: "http://www.miniui.com/demo/multiupload/src/image/vnd.svf" },
          ...
          { code: "*.pptx", text: "application/vnd.openxmlformats-officedocument.presentationml.presentation" },
           { code: "*.sldx", text: "application/vnd.openxmlformats-officedocument.presentationml.slide" },
            { code: "*.docx", text: "application/vnd.openxmlformats-officedocument.wordprocessingml.document" },
             ...
             { code: "*.xlsm", text: "http://www.miniui.com/demo/multiupload/src/application/vnd.ms-excel.addin.macroEnabled.12" },
             { code: "*.xlsb", text: " http://www.miniui.com/demo/multiupload/src/application/vnd.ms-excel.sheet.binary.macroEnabled.12" }
